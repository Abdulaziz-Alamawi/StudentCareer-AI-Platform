...
- [x] Roadmap generator (learning/cert/project/career)
...
- [x] Architecture, API, Database, Deployment docs

## Phase 6 — Future
- [ ] OpenAI provider for interview evaluation
- [ ] Real PDF parsing pipeline
- [ ] GitHub Actions CI (optional)
- [ ] E2E tests with Playwright
- [ ] Production screenshots for README
